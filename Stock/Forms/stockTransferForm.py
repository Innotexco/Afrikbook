...
class W_W_Form(forms.ModelForm):
    class Meta:
        ...
        fields = ['supplier', 'warehouse', 'description', 'item_decription', 'item', 'quantity', 'outlet', 'source', 'token_id', 'item_code', 'ref_no', 'Userlogin', 'selling_price', 'datetx']
        widgets = {
          ...
          'datetx': forms.DateInput(attrs={'class': 'w-full border rounded py-2 px-3', 'type': 'date'}),
...
class W_O_Form(forms.ModelForm):
  class Meta:
      ...
      fields = ['supplier', 'warehouse', 'description', 'item_decription', 'item', 'quantity', 'outlet',  'token_id', 'item_code', 'ref_no', 'Userlogin', 'selling_price', 'wholesale_price', 'datetx']
