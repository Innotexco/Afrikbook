...
class Vendor_invoice(models.Model):
    ...
    due_date            = models.DateField(max_length=250)                          # removed auto_now_add
    ...
    credit_purchase     = models.IntegerField(default=0, blank=True)   
    Transfer            = models.IntegerField(default=0, blank=True)
    Cash                = models.IntegerField(default=0, blank=True)
    POS                 = models.IntegerField(default=0, blank=True)
    Cheque              = models.IntegerField(default=0, blank=True)
    invoice_state       = models.CharField(max_length=50, default='Pending', blank=True)
